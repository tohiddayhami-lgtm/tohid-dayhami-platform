...
export const PRODUCTS_SAMPLE: MetaShop = {
  ...
  products: [
    ...
    { id: 'sp4', name: 'Iranian Red Apples — 10kg Export Carton', sku: 'TDH-APP-RED-10', hsCode: '08081000', group: 'Premium Fresh Fruits', description: 'Crisp Damavand high-altitude red apples, export-graded and waxed.', images: [`${CF}/hf_20260515_160627_d2dc14af-3a49-473a-a8b4-221301f05428.png`], active: true, currency: 'USD', price: 0.95, packPrice: 9.5, unit: 'kg', pack: 10, moq: '100000', stockLabel: 'In stock' },
...
export const SERVICES_SAMPLE: MetaShop = {
  ...
  products: [
    ...
    { id: 'ss3', name: 'Economy Car Rental — Daily', sku: 'SVC-CAR-ECO', group: 'Car Rental', description: 'Compact economy car rental in Muscat. Insurance and 200km/day included.', images: [`${CF}/hf_20260515_160830_d8bb0e62-ed41-4e9e-bf1e-3b086cacd6bf.png`], active: true, currency: 'OMR', price: 12, unit: 'day', priceUnit: 'per day', features: [{ label: 'Mileage', value: '200 km/day' }, { label: 'Insurance', value: 'Included' }, { label: 'Transmission', value: 'Automatic' }] },
    { id: 'ss4', name: 'SUV Rental — Daily', sku: 'SVC-CAR-SUV', group: 'Car Rental', description: 'Full-size SUV rental, ideal for desert and family trips. Insurance and 250km/day included.', images: [`${CF}/hf_20260515_160838_8fda62d3-3580-4ab2-a3e6-354d406285bf.png`], active: true, currency: 'OMR', price: 28, unit: 'day', priceUnit: 'per day', features: [{ label: 'Mileage', value: '250 km/day' }, { label: 'Seats', value: '7' }, { label: 'Insurance', value: 'Included' }] },
  ],
};
