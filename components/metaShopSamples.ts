...
export const PRODUCTS_SAMPLE: MetaShop = {
  ...
  defaultLang: 'en',
  directoryCategory: 'مواد غذایی', directorySubcategory: 'خشکبار و میوه', shopNumber: '01',
...
export const SERVICES_SAMPLE: MetaShop = {
  ...
  defaultLang: 'fa',
  directoryCategory: 'خدمات', directorySubcategory: 'اجاره و مشاوره', shopNumber: '02',
