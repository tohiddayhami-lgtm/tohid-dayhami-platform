...
export const PRODUCTS_SAMPLE: MetaShop = {
  ...
  defaultLang: 'en',
  directoryCategories: ['Food', 'Export'], directorySubcategory: 'Nuts & Dried Fruit', shopNumber: '01',
...
export const SERVICES_SAMPLE: MetaShop = {
  ...
  defaultLang: 'fa',
  directoryCategories: ['Services', 'Export'], directorySubcategory: 'Rental & Consulting', shopNumber: '02',
