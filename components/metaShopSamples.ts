...
export const PRODUCTS_SAMPLE: MetaShop = {
  ...
  defaultLang: 'en',
  directoryCats: [{ fa: 'مواد غذایی', en: 'Food' }, { fa: 'صادراتی', en: 'Export' }], directorySub: { fa: 'خشکبار و میوه', en: 'Nuts & Dried Fruit' }, shopNumber: '01',
...
export const SERVICES_SAMPLE: MetaShop = {
  ...
  defaultLang: 'fa',
  directoryCats: [{ fa: 'خدمات', en: 'Services' }, { fa: 'صادراتی', en: 'Export' }], directorySub: { fa: 'اجاره و مشاوره', en: 'Rental & Consulting' }, shopNumber: '02',
