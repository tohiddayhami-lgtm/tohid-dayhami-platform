...
const SAMPLE_BILINGUAL: NewsArticle[] = [
  // --- FA-primary: slug & title in Persian, both content fields filled ---
  {
    id: 'news_fa_001',
  ...
  // --- EN-primary: slug & title in English, both content fields filled ---
  {
    id: 'news_en_001',
    slug: 'oman-export-guide-2024',
    title: 'Complete Guide to Exporting to Oman in 2024',
    titleEn: 'Complete Guide to Exporting to Oman in 2024',
    summary: 'A step-by-step guide covering everything you need to know about exporting goods to Oman, from documentation to customs clearance.',
    summaryEn: 'A step-by-step guide covering everything you need to know about exporting goods to Oman, from documentation to customs clearance.',
    content: 'عمان یکی از استراتژیک‌ترین مقاصد تجاری در منطقه خلیج فارس است...\n\nمراحل کلیدی:\n۱. دریافت مجوز صادرات\n۲. ثبت سفارش صادراتی\n۳. آماده‌سازی مدارک گمرکی\n\nمدارک مورد نیاز:\n- فاکتور تجاری\n- بارنامه\n- گواهی مبدأ\n- لیست بسته‌بندی\n\nفرصت‌های تجاری:\nبازار عمان تقاضای بالایی برای محصولات غذایی، مواد ساختمانی و کالاهای مصرفی دارد.',
    contentEn: 'Oman is one of the most strategic trade destinations in the Gulf region...\n\nKey Steps:\n1. Obtain an export license\n2. Register your export order\n3. Prepare customs documentation\n\nRequired Documents:\n- Commercial Invoice\n- Bill of Lading\n- Certificate of Origin\n- Packing List\n\nTrade Opportunities:\nOman\'s market has strong demand for food products, construction materials, and consumer goods.',
    category: 'راهنما و آموزش',
    tags: ['oman', 'export', 'customs', 'trade', 'عمان', 'صادرات'],
    author: 'Tohid Dayhami Team / تیم توحید دیهمی',
    publishedAt: '2024-03-15T10:00:00.000Z', isPublished: true,
    coverImage: '', viewCount: 0,
    metaDescription: 'Step-by-step guide for exporting to Oman — documents, customs regulations, and trade opportunities.',
    metaKeywords: 'export to Oman, Oman customs, Gulf trade, صادرات به عمان'
  },
  {
    id: 'news_en_002',
    slug: 'eu-packaging-standards-exporters',
    title: 'EU Packaging Standards Every Exporter Must Know',
    titleEn: 'EU Packaging Standards Every Exporter Must Know',
    summary: 'Entering European markets requires strict packaging compliance. This article outlines the key standards and certifications required.',
    summaryEn: 'Entering European markets requires strict packaging compliance. This article outlines the key standards and certifications required.',
    content: 'اتحادیه اروپا برخی از سختگیرانه‌ترین استانداردهای بسته‌بندی در جهان را اعمال می‌کند...\n\nالزامات اصلی:\n- برچسب‌گذاری به زبان کشور مقصد\n- درج تاریخ انقضا و کد تولید\n- رعایت دستورالعمل‌های زیست‌محیطی\n\nگواهینامه‌های مورد نیاز:\n- علامت CE\n- ISO 22000 برای محصولات غذایی\n- REACH برای محصولات شیمیایی\n\nنکات مهم برای صادرکنندگان:\nبا یک طراح بسته‌بندی معتبر آشنا با استانداردهای اروپایی همکاری کنید.',
    contentEn: 'The European Union enforces some of the world\'s most rigorous packaging standards...\n\nCore Requirements:\n- Labeling in the destination country\'s language\n- Expiry date and production batch codes\n- Compliance with environmental directives\n\nRequired Certifications:\n- CE Marking\n- ISO 22000 for food products\n- REACH compliance for chemical products\n\nTips for Exporters:\nWork with a certified packaging designer familiar with EU norms to avoid costly rejections at customs.',
    category: 'قوانین و مقررات',
    tags: ['packaging', 'EU', 'standards', 'certification', 'بسته‌بندی', 'اروپا'],
    author: 'Tohid Dayhami Team / تیم توحید دیهمی',
    publishedAt: '2024-03-20T08:00:00.000Z', isPublished: true,
    coverImage: '', viewCount: 0,
    metaDescription: 'EU packaging standards for exporters — CE marking, ISO 22000, and labeling requirements explained.',
    metaKeywords: 'EU packaging standards, CE marking, export compliance, بسته‌بندی صادراتی'
  }
];
