  ...
  return (
    <div className="flex flex-col md:flex-row gap-5 min-h-[calc(100vh-100px)]">
      ...
      <div className="flex-grow">
        ...
        {activeTab === 'team_brainstorm' && (
          <TeamBrainstormPanel currentUser={currentUser} posts={teamBrainstormPosts} lang={lang} />
        )}
